  ...
  return (
    <PageWrapper>
      <section className="max-w-2xl mx-auto px-6 py-16">
        ...
        <motion.div
          className="mb-10 p-6"
          style={{ backgroundColor: 'rgba(15,15,26,0.6)', border: '1px solid rgba(0,220,192,0.15)' }}
          ...
          <form onSubmit={handleSaveName} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <p
                ...
                style={{ fontSize: '9px', letterSpacing: '1px', color: 'rgba(232,228,212,0.3)' }}
              >
            ...
            <div>
              ...
              <div
                ...
                style={{
                  fontSize: '11px',
                  letterSpacing: '2px',
                  color: isGoogleUser ? '#ffb830' : '#00dcc0',
                  border: `1px solid ${isGoogleUser ? 'rgba(255,184,48,0.3)' : 'rgba(0,220,192,0.3)'}`,
                  backgroundColor: 'rgba(15,15,26,0.8)',
                }}
              >
            ...
            <motion.button
              ...
              style={{
                fontSize: '11px',
                letterSpacing: '3px',
                backgroundColor: nameStatus === 'saved' ? 'rgba(0,220,192,0.2)' : 'rgba(0,220,192,0.1)',
                color: '#00dcc0',
                border: '1px solid rgba(0,220,192,0.3)',
              }}
              whileHover={{ backgroundColor: 'rgba(0,220,192,0.15)' }}
              whileTap={{ scale: 0.98 }}
            >
        ...
        {!isGoogleUser && (
          <motion.div
            className="mb-10 p-6"
            style={{ backgroundColor: 'rgba(15,15,26,0.6)', border: '1px solid rgba(255,184,48,0.15)' }}
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            <form onSubmit={handleChangePassword} className="flex flex-col gap-4">
              ...
              <motion.button
                ...
                style={{
                  fontSize: '11px',
                  letterSpacing: '3px',
                  backgroundColor: pwStatus === 'saved' ? 'rgba(255,184,48,0.2)' : 'rgba(255,184,48,0.1)',
                  color: '#ffb830',
                  border: '1px solid rgba(255,184,48,0.3)',
                }}
                whileHover={{ backgroundColor: 'rgba(255,184,48,0.15)' }}
                whileTap={{ scale: 0.98 }}
              >
        ...
        <motion.div
          className="p-6"
          style={{ backgroundColor: 'rgba(15,15,26,0.6)', border: '1px solid rgba(232,228,212,0.08)' }}
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <h2
            ...
            style={{ fontSize: '11px', letterSpacing: '3px', color: 'rgba(232,228,212,0.4)' }}
          >
            ACCOUNT INFO
          </h2>
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between py-2" style={{ borderBottom: '1px solid rgba(232,228,212,0.06)' }}>
              <span className="font-mono uppercase" style={{ ...labelStyle }}>User ID</span>
              <span className="font-mono truncate ml-4" style={{ fontSize: '11px', color: 'rgba(232,228,212,0.3)', maxWidth: '200px' }}>
                {user?.uid}
              </span>
            </div>
            <div className="flex items-center justify-between py-2">
              <span className="font-mono uppercase" style={{ ...labelStyle }}>Account Created</span>
              <span className="font-mono" style={{ fontSize: '11px', color: 'rgba(232,228,212,0.3)' }}>
